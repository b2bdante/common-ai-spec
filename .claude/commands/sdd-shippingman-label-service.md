Jira 티켓 $ARGUMENTS 기반으로 shippingman-label-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/shippingman-label-service.md` (서비스 전용 용어)
...
다중 배송사 라벨 서비스. CJ 등 배송사 송장번호 할당 범위(TrackingNumberRange) 관리, 라벨 생성/출력.
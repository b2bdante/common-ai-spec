Jira 티켓 $ARGUMENTS 기반으로 common-tracking-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/common-tracking-service.md` (서비스 전용 용어)
...
배송 추적 공통 서비스. 다중 배송사(UPS, FedEx 등) 추적 API 연동, Shipment 상태 동기화, FAQ 관리.

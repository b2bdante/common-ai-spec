Jira 티켓 $ARGUMENTS 기반으로 global-checkout-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/global-checkout-service.md` (서비스 전용 용어)
...
글로벌 체크아웃 서비스. 장바구니/주문/결제 관리, 셀러별 수수료/할인 정책, Toss Payments 연동, 상품 옵션 그룹(text/select/image), AI 중량/치수 추정, 쿠폰 코드 시스템, SQS 메시지 처리.
Jira 티켓 $ARGUMENTS 기반으로 common-crawling-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/common-crawling-service.md` (서비스 전용 용어)
...
이커머스 상품 크롤링 서비스. OliveYoung, Daiso, KTown4U 등 다양한 쇼핑몰 상품 수집. AI 프롬프트를 활용한 상품 분석(번역, 수출 검사) 지원.
Jira 티켓 $ARGUMENTS 기반으로 common-payment-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/common-payment-service.md` (서비스 전용 용어)
...
결제 공통 서비스. Toss Payments 연동, 다중 서비스/셀러별 결제 프로바이더 설정, 환불 처리. Payment 상태: CREATED/PAID/CANCEL/PARTIAL_CANCELED.
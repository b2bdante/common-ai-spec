Jira 티켓 $ARGUMENTS 기반으로 deliveredkorea-webuy-cat-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/deliveredkorea-webuy-cat-service.md` (서비스 전용 용어)
...
WeBuy/카탈로그 서비스. 구매 대행(BuyRequest), 번개장터/Tenso 마켓플레이스 연동, 패키지 관리(입고/합포장/리패킹), 포인트/쿠폰, 마케팅 이벤트, RPA 결제, 국내/국제 배송 관리.

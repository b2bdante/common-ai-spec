Jira 티켓 $ARGUMENTS 기반으로 x-border-service를 개발합니다.
...
- `common-ai-spec/back-end/glossary/x-border-service.md` (서비스 전용 용어)
...
크로스보더 배송 관리 서비스. 고객/관리자 이중 사용자, 배송사별 서비스/배송가능국가 관리, 배송 생성/추적/반송, 수출 통관 신고, 청구서/정산, 글로벌셀링 연동, 공지사항.